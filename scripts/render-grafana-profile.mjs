...
const url =
  ...
  "http://127.0.0.1:3000/d/oss-contrib/oss-contributions?orgId=1&viewPanel=3&kiosk&theme=dark";
...
await page.waitForSelector("text=Open Source Contributions", { timeout: 120000 });
